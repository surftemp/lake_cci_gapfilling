#!/bin/bash
#SBATCH --job-name=assemble_insitu_cv
#SBATCH -o assemble_insitu_cv.out
#SBATCH -e assemble_insitu_cv.err
#SBATCH --mem=128G
#SBATCH -t 24:00:00
...
echo "=========================================="
echo "In-Situ CV Assembly"
echo "Started: $(date)"
echo "Run root: $RUN_ROOT"
echo "=========================================="

python -u assemble_insitu_cv.py \
    --run-root $RUN_ROOT \
    --all
